...
function apri(chiave) {
    ...
    if(d[2]) { f.src = d[2]; f.style.display = "block"; } else { f.style.display = "none"; }
    
    var tris = document.getElementById('contenitore-tris');
    if(d[0] === 'Il Bambino') {
        tris.style.display = "flex";
        tris.innerHTML = `
            <img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446390/madre_pz7exh.jpg" class="foto-tris" style="width:90px;">
            <img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446386/bambino_vgddck.jpg" class="foto-tris" style="width:90px;">
            <img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446403/padre_ebpoxy.jpg" class="foto-tris" style="width:90px;">`;
    } 
    else if(d[0] === "L'Anziano") {
        tris.style.display = "flex";
        tris.innerHTML = `
            <img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768535131/incontro_wplvdz.png" class="foto-tris" style="width:140px;">
            <img src="https://res.cloudinary.com/dqoncufhc/image/upload/v1768446390/candela_ahabqh.gif" class="foto-tris" style="width:140px;">`;
    }
    else { tris.style.display = "none"; }
